		    ...
		    for (Item item : j.getPinguino().getInv().getLista()) {
		        if (item.getNombre().equals(nombreItem)) {
		            ...
		            if ("pez".equals(nombreItem)) {
		                ...
		                j.setProtegidoDelOso(true); // Método para proteger al jugador del Oso
		                ...
		                // Esta parte puede ser más compleja y dependerá de cómo gestiones los jugadores en tu juego
