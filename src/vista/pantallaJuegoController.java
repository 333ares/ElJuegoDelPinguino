...
public class pantallaJuegoController {
	...
	private boolean esJugador1() {
		return jugadorActual.equals(gestorJugador.getOtrosJugadores().get(0))
				|| (gestorJugador.getOtrosJugadores().size() == 1
						&& !jugadorActual.equals(gestorJugador.getOtrosJugadores().get(0)));
	}
	...
	public void handleRapido() {
		if (jugadorActual.getPinguino().getInv().contieneItem("dado rápido")) {
			...
			if (esJugador1()) {
				rapido_tP1.setText("No tienes dado lento.");
			} else {
				rapido_tP2.setText("No tienes dado lento.");
			}
			gestorJugador.jugadorFinalizaTurno(jugadorActual);
		}
	}
