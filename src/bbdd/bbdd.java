...
public class bbdd {
	 ...
	 * ENTENDAIS COMO FUNCIONA, SE HACE TODO DE MANERA AUTOMÁTICA.
	 *
	 * @return Objeto Connection si la conexión es exitosa, null en caso contrario.
	 *         LA VARIABLE QUE DEVUELVE LA TENEIS QUE GUARDAR PARA LAS DEMÁS
	 *         FUNCIONES
	 */
	...
	/**
	 * Realiza una consulta en la base de datos y devuelve los resultados como un
	 * ResultSet
	 *
	 ...
	 * CASO SI PODEIS IMPRIMIR MÁS DE UNA FILA.
	 *
	 * @param con                         Objeto Connection que representa la
	 *                                    conexión a la base de datos.
	 * @param sql                         Sentencia SQL de consulta.
